Создать стандартный Maven проект (архетип quickstart);
Найти в центральном репозитории и добавить зависимости: JUnit 4.13, SQLite JDBC (любой версии);
В pom.xml указать версию JDK на используемую.
